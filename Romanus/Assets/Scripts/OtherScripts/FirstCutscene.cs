...
public class FirstCutscene : MonoBehaviour
{
	...
	// this function loads the second paragraph of the first cutscene
	...
	// this function loads the third paragraph, as well as the button that starts the first level
