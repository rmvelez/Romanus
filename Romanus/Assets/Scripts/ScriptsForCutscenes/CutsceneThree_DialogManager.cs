...
public class CutsceneThree_DialogManager : MonoBehaviour
{
	public GameObject vicOne;

	public GameObject vicTwo;
	...
	void Start () {
		...
		vicTwo.gameObject.SetActive(false);
		roboCop.gameObject.SetActive(false);
	...
	public void DisplayNextSentence (){
		...
		else if (sentences.Count == 21)
		{
			Debug.Log("number is odd");
			vicTwo.gameObject.SetActive(false);
			roboCop.gameObject.SetActive(true);
			bulletOne.gameObject.SetActive(false);
			bulletTwo.gameObject.SetActive(false);
		}
